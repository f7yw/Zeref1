...
handler.command = /^(محاضرة|اختبار|lecture|exam|جدولي|جدول_كامل|حذف_محاضرة|حذف_اختبار|delsched|بث_للقروبات|broadcast_to|قروباتي|تشغيل_جدول|ايقاف_جدول|إيقاف_جدول)$/i
